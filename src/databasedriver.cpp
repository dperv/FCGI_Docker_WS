...
bool databaseDriver::objCreate(dataObject &obj)
{
   ...
   {
      std::cout << "Object insert error [ " << query.error()<<"]" << std::endl;
      return false;
   }
   return true;
}
...
bool databaseDriver::objUpdate(dataObject &obj)
{
...
bool databaseDriver::objDelete(dataObject &obj)
{
